...
public final class MetaItem
{
	...
	public static TIntIntMap getKeySizeMap(final int startIndex, final int endIndex, @Nonnull NonNullList<ItemStack> itemStacks)
	{
	...
	public static TIntIntMap getSmartKeySizeMap(final int startIndex, final int endIndex, @Nonnull NonNullList<ItemStack> itemStacks)
	{
