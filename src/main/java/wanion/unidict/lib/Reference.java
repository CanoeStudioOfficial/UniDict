...
public final class Reference
{
	...
	public static final String MOD_VERSION = "1.12.2-2.91";
	public static final String ACCEPTED_MINECRAFT = "[1.12,]";
	public static final String CLIENT_PROXY = "wanion.unidict.lib.proxy.ClientProxy";
	public static final String SERVER_PROXY = "wanion.unidict.lib.proxy.CommonProxy";
